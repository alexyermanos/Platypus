...
#' @param top.N.go.terms.plots The number of most significant GO-terms to be included in the go.plots. Default: 10.
...
#' @param top.N.kegg.terms.plots The number of most significant KEGG-terms to be included in the kegg.plots. Default: 10.
#' @param use.intput.list.as.title logical, whether or not to use the input list title as figure title.
