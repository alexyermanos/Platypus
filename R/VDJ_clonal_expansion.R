...
#'VDJ_clonal_expansion(VDJ.matrix = VDJ.GEX.matrix.out[[1]], celltype = "Bcells", clones = 30,subtypes = F, species = "Mouse",treat.incomplete.clones = "exclude",treat.incomplete.cells = "proportional", group.by = "seurat_clusters", color_by = "sample_id")
#'
#'#T cell plot with recoloring by vgene
#'VDJ_clonal_expansion(VDJ.matrix = VDJ.GEX.matrix.out[[1]], celltype = "Tcells", clones = 30, group.by = "sample_id", color_by = "VDJ_vgene")
#'
#'}
