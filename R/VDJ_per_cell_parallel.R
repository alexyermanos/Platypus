...
VDJ_per_cell <- function(clonotype.list,
  ...
  clonotype.list <- VDJ_analyze("Immunizations/mouse1/")
  VDJ.out.directory <- "Immunizations/mouse1/"
  vdj <- VDJ_analyze("Immunizations/mouse5/")
  vdj.per.cell <- VDJ_per_cell(vdj, "Immunizations/mouse5/")
