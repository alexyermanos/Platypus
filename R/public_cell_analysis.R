...
#'
#'@params find_public_cells_output Object, output of find_public_cells function
#'@params analysis.type Character, defines what analysis should be performed. Options are: "overlap type counts", "public cell numbers", "public clone numbers",  "clonal expansion by overlap type", "isotype usage of public cells" and "transcriptional cluster usage of public cells". Default is "overlap type counts".
#'@params inlcude.light.chain Logical, default is FALSE. Only needed if analysis.type = "clonal expansion by overlap type". If set to TRUE, also cdr3_aa light chain overlaps are colored in the created clonal expansion plots.
#'@params save.pot Logical, default is FALSE. If set to TRUE, created plots are saved in the current working directory.
#'
