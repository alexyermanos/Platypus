...
#'}
#'
GEX_phenotype_per_clone1 <- function(seurat.object,clonotype.ids){
  require(ggplot2)
  require(reshape2)
  ...
  temp.matrix <- matrix(0,nrow=length(clonotype.ids),ncol=length(possible_states))
