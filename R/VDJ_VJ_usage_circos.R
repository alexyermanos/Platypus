...
VDJ_VJ_usage_circos <- function(VDJ.GEX.matrix, A.or.B, label.threshold, cell.level, c.threshold, clonotype.per.gene.threshold, c.count, version, filter1H1L){
  require(reshape2)
  require(ggplot2)
  require(stringr)
  ...
  # In Case old Version of Platypus is being used: VDJ_analyze output is the input
