...
## ---- fig.show='hold', message=FALSE, eval = TRUE-----------------------------
...
## ---- fig.show='hold', message=FALSE,results = 'hide', eval = TRUE------------
...
## ----eval = TRUE, fig.show='hold', message=FALSE------------------------------
...
## ---- eval = TRUE, fig.show='hold',message=TRUE-------------------------------
