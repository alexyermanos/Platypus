...
## 4. Gene expression analysis (Platypus v2)
...
### 6.1 Reading in the clonotype data
...
### 6.3 Getting clonal information at the level of the single cell
...
### 6.4 Extracting full-length sequences from the VDJRegion
...
### 6.5 Extracting full-length germline sequence corresponding to the VDJRegion
...
### 6.6 Extracting trimmmed VDJ region sequence and germline
...
### 6.7 Organizing full-length sequences into clonal lineages easily exportable for phylogenetics. 
...
### 6.8 Neighbor-joining phylogenetic trees
...
### 6.9 Plotting per-cell isotype information 
...
### 6.10 Sequence similarity networks
...
### 6.11 Germline gene usage heatmaps 
...
### 6.12 Assessing CDR3 sequence similarity
...
## 7. Integrating repertoire and gene expression
...
### 7.1 Integrating transcriptional clusters to the VDJ objects
...
### 7.2 Relating clonal expansion to transcriptional cluster membership
...
### 7.3 Visualizing clones on the 2 dimensional landscape
...
### 7.4 Specific gene expression information on the clonal level
...
### 7.5 Integrating clonal lineage information and transcriptional cluster information
